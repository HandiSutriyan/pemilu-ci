    ...
    plot.hooks.draw.push(function (plot, ctx) {
      ...
      $.each(plot.getData(), function (ii, series) {
        ...
        for (let i = 0; i < series.data.length; i++) {
          ...
          let b =
            series.data[i].length > 2 && series.data[i][2]
              ? series.data[i][2]
              : 0;
          let px = null;
          let py = null;
          ...
          if (plot.getOptions().series.bars.horizontal) {
            ...
            let textInfo = barLabels.getTextInfo(
              layer,
              text,
              series.labels.font,
              series.labels.angle,
            ...
            if (
              Math.abs(series.xaxis.p2c(0) - width) - series.labels.padding <
              textInfo.width
            ) {
            ...
            if (
              Math.abs(series.yaxis.p2c(0) - series.yaxis.p2c(y)) -
